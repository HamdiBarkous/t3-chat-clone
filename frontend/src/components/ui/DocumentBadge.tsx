...
export function DocumentBadge({ 
  ...
  return (
    <div className={clsx(
      'inline-flex items-center gap-2 rounded-md border border-border bg-secondary text-text-primary',
      ...
      {showActions && onDelete && (
        <button
          ...
          className="ml-1 p-1 rounded hover:bg-destructive hover:text-destructive-foreground transition-colors"
